...
suffix="_unhinted";var fonts=[{"fontFamily":"SovbaRegular","url":wfpath+"27A5DC_0"+suffix+"_0."+webfontType}];var len=fonts.length;document.write("<style>");for(var i=0;i<len;i++){if(webfontType=="svg#wf"){var format="format(\"svg\")";}
